...
SuaraSah = int((output[4].rsplit('(',1)[0]).replace('.', ''))
TidakSah = int(output[5].replace('.', ''))
TPSterima = int((output[7].rsplit('(',1)[0]).replace('.', ''))
...
csv1 = f'{SuaraSah},{TidakSah},{TPSterima},{TotalTPS},{persPas01},{persPas02},{persTotTPS},' \
